...
Class clsRecordpromo { //promo Class @4-23D0AC71
...
//Class_Initialize Event @4-AE13AF33
    function clsRecordpromo()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->amount = new clsControl(ccsTextBox, "amount", "amount", ccsFloat, "", CCGetRequestParam("amount", $Method));
...
//Operation Method @4-F0532B86
    function Operation()
    {
        ...
        $Redirect = "PromoList.php?" . CCGetQueryString("QueryString", Array("Insert","Cancel","ccsForm"));
...
} //End promo Class @4-FCB6E20C

class clspromoDataSource extends clsDBDBNetConnect {  //promoDataSource Class @4-8045203E
...
//Insert Method @4-79594998
    function Insert()
    {
        ...
        ") VALUES (" .
            ...
            $this->ToSQL($this->amount->DBValue, $this->amount->DataType) . ", " .
            $this->ToSQL($this->group->DBValue, $this->group->DataType) . ", " .
...
} //End promoDataSource Class @4-FCB6E20C
...
$FileName = "AddPromo.php";
$Redirect = "";
$TemplateFileName = "Themes/AddPromo.html";
$BlockToParse = "main";
$PathToRoot = "./";
//End Initialize Page

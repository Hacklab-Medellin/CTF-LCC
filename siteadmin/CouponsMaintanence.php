...
Class clsRecordcoupons { //coupons Class @2-23D0AC71
...
//Class_Initialize Event @2-4875488E
    function clsRecordcoupons()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->discount = new clsControl(ccsTextBox, "discount", "discount", ccsFloat, Array(False, 2, ".", "", False, "", "", 1, True, ""), CCGetRequestParam("discount", $Method));
...
//Operation Method @2-578A57D6
    function Operation()
    {
        ...
        $Redirect = "couponsList.php?" . CCGetQueryString("QueryString", Array("Update","Delete","Cancel","ccsForm"));
        if($this->PressedButton == "Delete") {
            if(!CCGetEvent($this->Delete->CCSEvents, "OnClick") || !$this->DeleteRow()) {
                $Redirect = "";
            } else {
                $Redirect = "couponsList.php?" . CCGetQueryString("QueryString", array("ccsForm"));
            }
...
} //End coupons Class @2-FCB6E20C

class clscouponsDataSource extends clsDBDBNetConnect {  //couponsDataSource Class @2-8045203E
...
//Delete Method @2-F0FA3EAD
    function Delete()
    {
        ...
        $SQL = "DELETE FROM coupons WHERE " . $this->Where;
...
//Update Method @2-8502C6F8
    function Update()
    {
        ...
        $SQL = "UPDATE coupons SET " .
            "`discount`=" . $this->ToSQL(($this->discount->DBValue/100), $this->discount->DataType) . ", " .
...
} //End couponsDataSource Class @2-FCB6E20C
...
$FileName = "CouponsMaintanence.php";
$Redirect = "";
$TemplateFileName = "Themes/CouponsMaintanence.html";
$BlockToParse = "main";
$PathToRoot = "./";
//End Initialize Page

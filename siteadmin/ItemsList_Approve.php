...
//Prepare Method @12-224254FC
    function Prepare()
    {
        ...
        $this->wp->AddParameter("5", "urls_status", ccsInteger, "", "", "99", "");
...
$FileName = "ItemsList_Approve.php";
$Redirect = "";
$TemplateFileName = "Themes/ItemsList_Approve.html";
$BlockToParse = "main";
$PathToRoot = "./";
//End Initialize Page
...
if ($_GET["approve"]) {
	...
	$db = new clsDBNetConnect;
	$query = "select * from `items` where `ItemNum` = '" . $_GET["Item_Number"] . "' and `status` = '99'";
	$db->query($query);
	if ($db->next_record()){
		$close = $db->f("close");

...
//Class_Initialize Event @54-9A757589
...
//Validate Method @54-7108F167
    function Validate()
    {
        ...
        $Validation = ($this->states->Validate() && $Validation);
...
//Class_Initialize Event @54-E8030AB8
    function clsitems1DataSource()
    {
        ...
        $this->states = new clsField("states", ccsText, "");
...
//SetValues Method @54-E1F28F49
    function SetValues()
    {
        ...
        $this->states->SetDBValue($this->f("state_province"));
        $this->description->SetDBValue($this->f("description"));
        $this->dateadded->SetDBValue($this->f("dateadded"));
        $this->added_description->SetDBValue($this->f("added description"));
...
//Update Method @54-D13A6CC9
    function Update()
    {
        ...
        $SQL = "UPDATE items SET "
             ...
             . "state_province=" . $this->ToSQL($this->states->GetDBValue(), $this->states->DataType) . ", "
             ...
             . "added description=" . $this->ToSQL($this->added_description->GetDBValue(), $this->added_description->DataType) . ", "
...
//Include Page implementation @37-B991DFB8

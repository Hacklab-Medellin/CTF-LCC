...
class clsGriditems2 { //items1 class @19-239DFDFA
...
//Class_Initialize Event @19-23CAD8F7
    function clsGriditems2()
    {
        global $FileName;
        global $now;
        $this->ComponentName = "items2";
        $this->Visible = True;
        $this->Errors = new clsErrors();
        $this->ds = new clsitems2DataSource();
...
} //End items2 Class @19-FCB6E20C

class clsitems2DataSource extends clsDBNetConnect {  //items2DataSource Class @19-30AAB679
